...
const Output = (props) => {
    ...
    return (
        <Box sx={{ bgcolor: '#cfe8fc' , mt:"5vh", w:1}}>
            <Toolbar name={name} />
            <article id="output" className="markdown-body">
...
const Input = () => {
    ...
    return (
        <>
            <Toolbar  name={name} />
            <div id="input" className="h-full">
                <textarea onChange={handlechange} className=" w-full h-full p-2 box-border border-none bg-[#0d1117] text-white">{coba}</textarea>
            </div>
